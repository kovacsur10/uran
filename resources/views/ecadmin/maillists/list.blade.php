    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">{{ $layout->language('mailing_lists') }}</div>
				...
				@if($layout->user()->permitted('mailing_lists_handling'))
						...
						<div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" action="{{ url('/ecadmin/maillist/show') }}">
								...
								<div class="form-group{{ $errors->has('mailing_lists') ? ' has-error' : '' }}">
									<label  class="col-md-4 control-label" for="mailing_lists">{{ $layout->language('mailing_list') }}</label>
									<div class="col-md-6">
					...
					<div class="panel panel-default">
						<div class="panel-heading">{{ $layout->language('mailing_lists_diff') }}</div>
						<div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" action="{{ url('/ecadmin/maillist/showdiff') }}">
								...
								<div class="form-group{{ $errors->has('mailing_lists_textarea') ? ' has-error' : '' }}">
									<label class="col-md-4 control-label" for="mailing_lists_textarea">{{ $layout->language('mailing_list_actual_content') }}</label>
									<div class="col-md-6">
